      ...
      {open && (
        ...
        >
          <div className="border-b border-dashed border-base-800 px-3 py-2">
            <div className="text-[11px] font-semibold text-base-200">{label}</div>
            <div className="mt-0.5 font-mono text-[10px] text-base-500">SecuriSphere SOC</div>
          </div>
            ...
            {items.map((it) => {
              ...
              return (
                <button
                  ...
                  role="menuitem"
                  onClick={() => go(it.path)}
                  className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-[11px] text-base-300 hover:bg-base-800/60 hover:text-base-100"
                >
          ...
          {onLogout && (
            <div className="border-t border-dashed border-base-800 py-1">
              <button
                ...
                className="flex w-full items-center gap-2 px-3 py-1.5 text-left text-[11px] text-red-300 hover:bg-red-500/10 hover:text-red-200"
              >
